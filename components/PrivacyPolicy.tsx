...
export const PrivacyPolicy: React.FC<PrivacyPolicyProps> = ({ onNavigate }) => {
  ...
  return (
    <section className="min-h-screen bg-neutral-950 pt-32 pb-24 px-6">
      <div className="container mx-auto max-w-4xl">
        ...
        >
          <div className="space-y-8 text-neutral-300">
            ...
            <section className="bg-neutral-900/40 border border-white/5 rounded-xl p-6">
            ...
            <section className="bg-neutral-900/40 border border-white/5 rounded-xl p-6">
              ...
              <ul className="list-disc list-inside space-y-2 text-neutral-400">
                <li><strong className="text-neutral-300">Contact Information:</strong> Name, email address, phone number, and business name</li>
                <li><strong className="text-neutral-300">Business Information:</strong> Industry, website URL, and call volume data</li>
                <li><strong className="text-neutral-300">Call Data:</strong> Phone call recordings, transcripts, and metadata when using our AI receptionist service</li>
                <li><strong className="text-neutral-300">Usage Data:</strong> How you interact with our website and services</li>
                <li><strong className="text-neutral-300">Device Information:</strong> IP address, browser type, and operating system</li>
              </ul>
            </section>
            ...
            <section className="bg-neutral-900/40 border border-white/5 rounded-xl p-6">
              ...
              <ul className="list-disc list-inside space-y-2 text-neutral-400">
                <li><strong className="text-neutral-300">Service Providers:</strong> Third parties who perform services on our behalf (hosting, analytics, payment processing)</li>
                <li><strong className="text-neutral-300">Business Transfers:</strong> In connection with a merger, acquisition, or sale of assets</li>
                <li><strong className="text-neutral-300">Legal Requirements:</strong> When required by law or to protect our rights</li>
                <li><strong className="text-neutral-300">With Your Consent:</strong> When you have given us permission to share</li>
              </ul>
            </section>
            ...
            <section className="bg-neutral-900/40 border border-white/5 rounded-xl p-6">
              ...
              <ul className="list-disc list-inside space-y-2 text-neutral-400">
                ...
                <li><strong className="text-neutral-300">Deletion:</strong> Request deletion of your personal data</li>
                <li><strong className="text-neutral-300">Portability:</strong> Request transfer of your data to another service</li>
                <li><strong className="text-neutral-300">Opt-out:</strong> Unsubscribe from marketing communications</li>
              </ul>
            ...
            <section className="bg-neutral-900/40 border border-white/5 rounded-xl p-6">
              ...
              <div className="text-neutral-400 space-y-1">
                <p><strong className="text-neutral-300">Autoquill Inc.</strong></p>
