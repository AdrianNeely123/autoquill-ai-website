        ...
        >
          <div className="space-y-8 text-neutral-300">
            ...
            <section className="bg-neutral-900/40 border border-white/5 rounded-xl p-6">
              ...
              <ul className="list-disc list-inside space-y-2 text-neutral-400">
                <li><strong className="text-neutral-300">Billing:</strong> Fees are billed monthly in advance on the subscription date</li>
                <li><strong className="text-neutral-300">Payment Methods:</strong> We accept major credit cards and ACH transfers</li>
                <li><strong className="text-neutral-300">Price Changes:</strong> We may change prices with 30 days' notice</li>
                <li><strong className="text-neutral-300">Refunds:</strong> We offer a 30-day money-back guarantee for new customers</li>
                <li><strong className="text-neutral-300">Cancellation:</strong> You may cancel your subscription at any time with 30 days' notice</li>
              </ul>
            </section>
            ...
            <section className="bg-neutral-900/40 border border-white/5 rounded-xl p-6">
              <h2 className="text-xl font-semibold text-white mb-4">8. Call Recording Consent</h2>
              <p className="leading-relaxed mb-4">
            ...
            <section className="bg-neutral-900/40 border border-white/5 rounded-xl p-6">
              <h2 className="text-xl font-semibold text-white mb-4">9. Service Level Agreement</h2>
              <p className="leading-relaxed mb-4">
