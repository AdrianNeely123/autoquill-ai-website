...
export const FreeAgent: React.FC = () => {
  ...
  return (
    <div className="pt-32 pb-24 px-6 min-h-screen relative bg-neutral-950 flex flex-col items-center">
       {/* Background Grid */}
      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          >
            Stop answering the same questions 50 times a day. We will build you a custom AI agent that answers your FAQs instantly—completely free.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 items-start">
            ...
            <div className="md:col-span-2 space-y-6">
                ...
                >
                    ...
                    <p className="text-sm text-neutral-400">Your agent learns your hours, pricing, and services to answer customers immediately.</p>
                </motion.div>
                ...
                >
                    ...
                    <p className="text-sm text-neutral-400">Powered by our ultra-fast infrastructure for natural, human-like conversation.</p>
                </motion.div>
                ...
                >
                    ...
                    <h3 className="text-white font-semibold mb-2">No Setup Cost</h3>
                    <p className="text-sm text-neutral-400">We build the initial configuration for you. Just plug it in and start saving time.</p>
                </motion.div>
            </div>
            ...
            >
                ...
                {status === 'success' ? (
                    <div className="flex flex-col items-center justify-center text-center py-12 space-y-6">
                        <div className="w-20 h-20 bg-green-500/10 rounded-full flex items-center justify-center mb-2 ring-1 ring-green-500/20">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
                        <h3 className="text-xl font-bold text-white mb-6 border-b border-white/5 pb-4">Agent Configuration</h3>
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-medium text-neutral-400 uppercase tracking-wider ml-1">Company Name</label>
                            <input 
                                required
                                name="companyName"
                                type="text" 
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                             <div className="space-y-2">
                                <label className="text-xs font-medium text-neutral-400 uppercase tracking-wider ml-1">Company Website</label>
                                <input 
                                    required
                                    name="website"
                                    type="text" 
                             ...
                             <div className="space-y-2">
                                <label className="text-xs font-medium text-neutral-400 uppercase tracking-wider ml-1">Industry</label>
                                <input 
                                    required
                                    name="industry"
                                    type="text" 
                        ...
                        <div className="pt-6">
                            ...
                            >
                                {status === 'loading' ? (
                                    ...
                                    <>
                                        Build My Free Agent <Send size={16} className="group-hover:translate-x-1 transition-transform" />
                                    </>
                                )}
                            </button>
                        </div>
