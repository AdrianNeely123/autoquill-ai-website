  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 max-w-5xl relative z-10">
            ...
            {!isPlaying ? (
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-neutral-900 to-neutral-950">
                ...
                <button
                  ...
                  className="relative z-10 w-20 h-20 flex items-center justify-center rounded-full bg-accent hover:bg-accent-dark text-gray-900 transition-all hover:scale-110 shadow-[0_0_40px_rgba(139,92,246,0.5)] group-hover:shadow-[0_0_60px_rgba(139,92,246,0.7)]"
        ...
        >
          <div className="text-center p-6 bg-gray-100/30 border border-white/5 rounded-xl">
            <div className="text-2xl font-bold text-accent mb-2">&lt;500ms</div>
            <div className="text-sm text-gray-600">Response Time</div>
          </div>
          <div className="text-center p-6 bg-gray-100/30 border border-white/5 rounded-xl">
            <div className="text-2xl font-bold text-accent mb-2">100%</div>
            <div className="text-sm text-gray-600">Natural Voice</div>
          </div>
          <div className="text-center p-6 bg-gray-100/30 border border-white/5 rounded-xl">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              ...
              className="px-8 py-4 bg-accent hover:bg-accent-dark text-gray-900 rounded-xl font-bold transition-all hover:shadow-lg hover:shadow-accent/20 flex items-center gap-2"
            >
              ...
              <div className="bg-gradient-to-r from-accent to-purple-600 rounded-2xl p-4 shadow-2xl shadow-accent/30">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-gray-900 font-bold text-sm">Like what you see?</p>
                    <p className="text-gray-900/80 text-xs">Get your free AI agent in 2 minutes</p>
                  </div>
                  <button
                    onClick={() => {
                  ...
                  <button
                    ...
                    className="p-1 text-gray-900/60 hover:text-gray-900 transition-colors"
                    aria-label="Dismiss"
                  >
                    <X size={18} />
                  </button>
