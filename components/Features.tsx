  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full">
        <div className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-white mb-4 group-hover:scale-110 group-hover:bg-accent group-hover:text-white transition-all duration-300 shadow-sm" aria-hidden="true">
          {icon}
        </div>
    ...
    >
      <div className="container mx-auto px-6 max-w-7xl">
        <header className="mb-16 text-center max-w-2xl mx-auto">
          ...
          <p className="text-neutral-400 text-lg" itemProp="description">
             A complete <strong className="text-neutral-300">AI phone answering</strong> suite that answers calls, manages your calendar, and learns your business inside out. Perfect for <em>dentists, HVAC companies, plumbers, med spas, law firms</em>, and more.
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(300px,auto)]" role="list">
          ...
          >
             <div className="w-full bg-neutral-900/50 rounded-lg border border-white/5 p-4 relative overflow-hidden h-32 flex items-center justify-around gap-2" aria-hidden="true">
                {/* Mock Calendar UI */}
          ...
          >
             <div className="mt-4 relative h-full min-h-[200px] bg-neutral-900 rounded-xl overflow-hidden flex flex-col items-center justify-center p-6 text-center group-hover:bg-accent/5 transition-colors border border-white/5" aria-hidden="true">
          ...
          >
              <div className="mt-4 flex items-center justify-between bg-neutral-900 rounded-lg p-3 border border-white/10">
                  ...
                  <span className="text-xs font-bold text-accent">Online 24/7</span>
              </div>
          </FeatureCard>
          ...
          >
             <div className="mt-4 flex items-center gap-4">
                 <div className="flex-1 h-2 bg-neutral-800 rounded-full overflow-hidden" role="progressbar" aria-valuenow={10} aria-valuemin={0} aria-valuemax={100} aria-label="Cost comparison: Autoquill is 90% cheaper">
